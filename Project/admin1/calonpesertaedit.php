    ...
    <div class="container">
		<div class="content">
			...
			if(isset($_POST['save'])){
				...
				$update = mysqli_query($koneksi, "UPDATE `calon_peserta` SET `nama`='$nama',`nik`='$nik',`tempat_lahir`='$tempat',`tanggal_lahir`='$tanggal',`jenis_kelamin`='$jk',`telepon`='$tlp',`email`='$email',`alamat`='$alamat',`kode_pos`='$kp',`provinsi`='$prov',`pendidikan`='$pendidikan',`status`='$status' WHERE id_daftar='$id'") or die(mysqli_error());
				if($update){
