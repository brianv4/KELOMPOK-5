  ...
  <div id="wrapper">
    ...
    <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
          ...
          <a class="dropdown-item" href="gallery/gallery.php">Galeri</a>
          <div class="dropdown-divider"></div>
    ...
    <li class="nav-item dropdown">
        ...
        <a class="dropdown-item" href="">Materi Kursus</a>
          <a class="dropdown-item" href="materikursus.php">Topik Kursus</a>
          <a class="dropdown-item" href="materipelatihan.php">Topik Pelatihan</a>
    </li>
    <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" id="pagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
          ...
          <a class="dropdown-item" href="upload/">Upload Materi</a>
