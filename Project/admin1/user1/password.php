...
<body>
	...
	<div class="container">
		<div class="content">
			...
			<p>Ganti Password untuk mahasiswa dengan NIM <?php echo '<b>'.$_GET['ID_USER'].'</b>'; ?></p>
			...
			if(isset($_POST['ganti'])){
				...
				$cek = mysqli_query($koneksi, "SELECT * FROM user WHERE ID_USER='$id' AND PASSWORD='$password'");
				if(mysqli_num_rows($cek) == 0){
					...
					if($password1 == $password2){
						if(strlen($password1) >= 5){
							$pass = md5($password1);
							$update = mysqli_query($koneksi, "UPDATE user SET PASSWORD='$password' WHERE ID_USER='$id'");
							if($update){
