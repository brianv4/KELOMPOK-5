	...
	<div class="container">
		<div class="content">
			...
			if(isset($_POST['add'])){
				...
				$cek = mysqli_query($koneksi, "SELECT * FROM 'topik_kursus'");
				if(mysqli_num_rows($cek) == 0){
					$insert = mysqli_query($koneksi, "INSERT INTO `topik_kursus`(`id_topik`, `topik`, `tgl_mulai`, `tgl_akhir`, `deskripsi`, `file`, `status`, `kuota`) VALUES ('','$topik','$tglmulai','$tglakhir','$deskripsi','$file','$status','$kuota')") or die(mysqli_error($koneksi));
						if($insert){
