...
(
   ID_MATERIKURSUS      varchar(6) not null,
...
(
   ID_MATERIPELATIHAN   varchar(6) not null,
...
(
   NIK_KURSUS           numeric(7,0) not null,
   ID_MATERIKURSUS      varchar(6) not null,
   HARI                 varchar(10),
   TANGGAL              datetime,
...
(
   NOMOR_SERTIFIKATKURSUS varchar(20) not null,
   ID_USER              varchar(6) not null,
   ID_UJIANKURSUS       varchar(20),
...
(
   NOMOR_SERTIFIKATPELATIHAN varchar(20) not null,
   ID_USER              varchar(6),
   ID_UJIANPELATIHAN    varchar(20) not null,
...
(
   ID_UJIANKURSUS       varchar(20) not null,
   NIK_KURSUS           numeric(7,0) not null,
   NILAI_KURSUS         int,
