		...
		<div class="content">
			...
			if(isset($_POST['add'])){
				...
				if(mysqli_num_rows($cek) == 0){
					$insert = mysqli_query($koneksi, "INSERT INTO `topik_pelatihan`(`id_topik`, `topik`, `tgl_mulai`, `tgl_akhir`, `deskripsi`, `file`, `status`, `kuota`) VALUES ('$id','$topik','$tglmulai','$tglakhir','$deskripsi','$file','$status','$kuota')") or die(mysqli_error($koneksi));
						if($insert){
			...
			<form class="form-horizontal" action="" method="post">
				<div class="form-group">
					...
					<div class="col-sm-2">
						<input type="text" name="id_topik" class="form-control" placeholder="id topik" required>
					</div>
				</div>
				<div class="form-group">
