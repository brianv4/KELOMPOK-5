...
$sql=mysqli_query($koneksi,"SELECT password FROM user where password='$oldpassword'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
$username=$_SESSION['username'];
$newpass=MD5($_POST['newpass']);
 $ret=mysqli_query($koneksi,"update user set password='$newpass' where username='$username'");
				...
				<div class="row">
                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          ...
                          <button><a href="admin/halaman_owner.php">Kembali</a></button>
                          </form>
                      </div>
                  </div>
              </div>
