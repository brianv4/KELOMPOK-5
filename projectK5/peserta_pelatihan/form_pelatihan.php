	...
	<div class="container">
		<div class="content">
			...
			if(isset($_POST['form_pelatihan'])){
				...
				$cek = mysqli_query($koneksi, "SELECT * FROM peserta_pelatihan WHERE id_daftar='$id'");
				if(mysqli_num_rows($cek) == 0){
                    if($pass1==$pass2){
                        $pass = $pass1;
                    
					$insert = mysqli_query($koneksi, "INSERT INTO `peserta_pelatihan`(`id_daftar`, `nama`, `nik`, `tempat_lahir`, `tanggal_lahir`, `jenis_kelamin`, `telepon`, `email`, `username`, `password`, `alamat`, `kode_pos`, `provinsi`, `pendidikan`, `file_ktp`, `file_kk`, `file_ijazah`,`status`) VALUES ('$id','$nama','$nik','$tempat_lahir','$tanggal_lahir','$jenis_kelamin','$telepon','$email','$username','$pass','$alamat','$kode_pos','$provinsi','$pendidikan','$file_ktp','$file_kk','$file_ijazah','$status')") or die(mysqli_error($koneksi));
						if($insert){
			...
			<form class="form-horizontal" action="" method="post">
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input type="submit" name="form_pelatihan" class="btn btn-primary" value="TAMBAH">
