	...
	<div class="container">
			<div class="content">
				...
				if(isset($_GET['aksi']) == 'delete'){
					$id = $_GET['id_topik'];
					$cek = mysqli_query($koneksi, "SELECT * FROM materi_pelatihan WHERE id_topik='$id'");
				...
				<a href="matpeladd.php" class="btn btn-primary">Tambah</a>
				<br>
				...
				<table class="table table-striped table-hover">
					...
					<?php
					if($urut){
						$sql = mysqli_query($koneksi, "SELECT * FROM materi_pelatihan WHERE status='$urut' ORDER BY id_topik ASC");
					}else{
						$sql = mysqli_query($koneksi, "SELECT * FROM materi_pelatihan ORDER BY id_topik ASC");
					}
