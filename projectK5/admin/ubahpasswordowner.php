...
<div class="container">
		<div class="content">
        <h2><i class="fas fa-unlock-alt"></i> UBAH PASSWORD</h2>
				<div class="row">
                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          ...
                          <div>
                          <input type="submit" name="Submit" value="Change" class="btn btn-success"></input>
                          <a href="halaman_owner.php" class="btn btn-success">BACK</a>
                          </div>
                          <button></button>
                          </form>
                      </div>
