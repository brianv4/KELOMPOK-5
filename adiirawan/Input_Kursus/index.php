...
<div class="container">
  <div class="panel panel-default">
    <div class="panel-heading">Input Materi Kursus</div>
    <div class="panel-body">
    
       <form action="actionkursus.php" method="POST">
	        <div class="input-group control-group after-add-more">
	          <input type="text" name="addmore[]" class="form-control" placeholder="Materi Kursus">
